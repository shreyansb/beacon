...
def oauth_wrap(consumer, token, http):
    ...
    def new_request(uri, method='GET', body=None, headers=None,
      ...
      headers['user-agent'] = settings.LAT_HEADERS.get('user-agent')
      #print headers
...
def get_wrapped_http(oauth_params):
  consumer = oauth.Consumer(settings.LAT_CONSUMER_KEY, settings.LAT_CONSUMER_SECRET)
